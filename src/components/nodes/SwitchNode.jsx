...
import { Server, Trash2, CheckCircle2, AlertCircle, Moon } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center pt-8 pb-3 px-2 min-h-[110px]">
        {/* Ikon Perangkat */}
        <div className="w-10 h-10 bg-white shadow-sm border border-slate-100 rounded-xl flex items-center justify-center mb-2 text-emerald-500 transform transition-transform hover:scale-105">
          <Server size={20} strokeWidth={1.5} />
        </div>
        
        {/* Info */}
        <div className="w-full flex flex-col items-center">
          <h3 className="font-bold text-slate-700 text-[11px] tracking-tight truncate w-full text-center">Switch {data.index || 1}</h3>
